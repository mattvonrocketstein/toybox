...
# to be changed in two places. toybox/__init__.py is also free
# to import various requirements that haven't been installed yet
sys.path.append(os.path.join(this_dir, 'toybox'))
from version import __version__
sys.path.pop()

base_url = 'https://github.com/mattvonrocketstein/toybox/'
setup(
    name         = 'toybox',
    version      = __version__,
    description  = 'command and control for toybox',
    ...
    entry_points = {
        'console_scripts': \
        ['toybox = toybox.bin._toybox:entry', ] },
    install_requires=[],
    )
